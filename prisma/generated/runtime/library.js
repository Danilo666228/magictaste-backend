...
var K = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
	...
	Ao = (e, t, r, n) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let i of gu(t)) !yu.call(e, i) && i !== r && Jt(e, i, { get: () => t[i], enumerable: !(n = fu(t, i)) || n.enumerable })
		return e
	}
var D = (e, t, r) => (
		(r = e != null ? mu(hu(e)) : {}), Ao(t || !e || !e.__esModule ? Jt(r, 'default', { value: e, enumerable: !0 }) : r, e)
	),
...
`
	...
	function Ac(e) {
		...
		return t
			? G._configVault(e)
			: (Tc(`You set DOTENV_KEY but you are missing a .env.vault file at ${t}. Did you forget to build it?`), G.configDotenv(e))
	}
	function Ic(e, t) {
	...
	function kc(e, t, r = {}) {
		...
		for (let o of Object.keys(t))
			Object.prototype.hasOwnProperty.call(e, o)
				? (i === !0 && (e[o] = t[o]),
					n &&
						zr(i === !0 ? `"${o}" is already defined and WAS overwritten` : `"${o}" is already defined and was NOT overwritten`))
				: (e[o] = t[o])
	}
...
function ec(e) {
	return ft(e)
		...
		.with(
			{ familyDistro: 'debian' },
			({ archFromUname: t }) => (
				ie('Trying platform-specific paths for "debian" (and "ubuntu")'), [`/usr/lib/${t}-linux-gnu`, `/lib/${t}-linux-gnu`]
			)
		)
...
function Mc(e) {
	return JSON.parse(
		JSON.stringify(e, (t, r) => (Array.isArray(r) ? `[${r.map(n => JSON.stringify(n)).join(', ')}]` : JSON.stringify(r)))
	)
}
var ir = {}
...
f.hyperbolicCosine = f.cosh = function () {
	...
	;(r = s.precision),
		...
		(s.rounding = 1),
		(i = o.d.length),
		i < 32 ? ((e = Math.ceil(i / 3)), (t = (1 / pn(4, e)).toString())) : ((e = 16), (t = '2.3283064365386962890625e-10')),
...
f.toExponential = function (e, t) {
	...
	return (
		e === void 0
			? (r = Te(n, !0))
			: (ae(e, 0, ze), t === void 0 ? (t = i.rounding) : ae(t, 0, 8), (n = E(new i(n), e + 1, t)), (r = Te(n, !0, e + 1))),
...
f.toSignificantDigits = f.toSD = function (e, t) {
	var r = this,
		n = r.constructor
	return (
		e === void 0 ? ((e = n.precision), (t = n.rounding)) : (ae(e, 1, ze), t === void 0 ? (t = n.rounding) : ae(t, 0, 8)),
		E(new n(r), e, t)
	)
}
f.toString = function () {
	...
	return (
		...
		n == null
			...
			: t < 4
				...
				: (s =
						(((n || r < 4) && a + 1 == o) || (!n && r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 1e3) | 0) == J(10, t - 3) - 1),
		s
	)
}
function nn(e, t, r) {
...
function Hc(e, t) {
	...
	;(n = t.d.length),
		n < 32 ? ((r = Math.ceil(n / 3)), (i = (1 / pn(4, r)).toString())) : ((r = 16), (i = '2.3283064365386962890625e-10')),
		(e.precision += r),
...
function Te(e, t, r) {
	...
	return (
		t
			? (r && (n = r - s) > 0 ? (o = o.charAt(0) + '.' + o.slice(1) + He(n)) : s > 1 && (o = o.charAt(0) + '.' + o.slice(1)),
				(o = o + (e.e < 0 ? 'e' : 'e+') + e.e))
			: i < 0
...
function on(e, t) {
	...
	if (((t = t.slice(n, i)), t)) {
		...
		for (; n--; ) t += '0'
		e.d.push(+t),
			w && (e.e > e.constructor.maxE ? ((e.d = null), (e.e = NaN)) : e.e < e.constructor.minE && ((e.e = 0), (e.d = [0])))
	} else (e.e = 0), (e.d = [0])
	return e
}
function Kc(e, t) {
	...
	if ((h ? (ae(r, 1, ze), n === void 0 ? (n = g.rounding) : ae(n, 0, 8)) : ((r = g.precision), (n = g.rounding)), !e.isFinite()))
		...
		for (
			c = Te(e),
				...
				s >= 0 && ((c = c.replace('.', '')), (m = new g(1)), (m.e = c.length - s), (m.d = nn(Te(m), 10, i)), (m.e = m.d.length)),
				p = nn(c, 10, i),
				o = l = p.length;
			p[--l] == 0;
		...
		if (!p[0]) c = h ? '0p+0' : '0'
			...
			if (
				(s < 0 ? o-- : ((e = new g(e)), (e.d = p), (e.e = o), (e = $(e, m, r, n, 0, i)), (p = e.d), (o = e.e), (u = Ms)),
				(s = p[r]),
				(a = i / 2),
				(u = u || p[r + 1] !== void 0),
				(u =
			...
			for (let y in r) {
				...
				for (let T = 0; T < O.length; ++T) {
					...
					for (let Q = n, se = i; Q < t.length; se += t[Q].length, ++Q) {
						...
						if (
							(Z.push(mt), h && Z.push(h), Array.prototype.splice.apply(t, Z), u != 1 && P.matchGrammar(e, t, r, Q, se, !0, y), o)
						)
							break
					}
				}
...
function Ln({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
	if (Array.isArray(t)) {
		for (let s = 0; s < t.length; s++) t[s] = Ln({ result: t[s], args: r, modelName: i, runtimeDataModel: n, visitor: e })
		return t
	}
	let o = e(t, i, r) ?? t
	return (
...
function Mm(e) {
	...
	let r = Al.default.toNamespacedPath(e),
		...
		i = 0
	return (
		process.platform !== 'win32' && (i = Eo.default.constants.dlopen.RTLD_LAZY | Eo.default.constants.dlopen.RTLD_DEEPBIND),
...
function _l({ copyEngine: e = !0 }, t) {
	...
	e &&
		n &&
		or('recommend--no-engine', 'In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)')

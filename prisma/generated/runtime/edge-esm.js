...
var Le = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
	...
	wa = (e, t, r, n) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let i of fa(t)) !ha.call(e, i) && i !== r && ar(e, i, { get: () => t[i], enumerable: !(n = da(t, i)) || n.enumerable })
		return e
	}
var We = (e, t, r) => (
	...
	var pi = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
		Ea = pi(e => {
			...
			function g(R) {
				...
				for (Q = 0; Q < B; Q += 4)
					(S =
						(r[R.charCodeAt(Q)] << 18) | (r[R.charCodeAt(Q + 1)] << 12) | (r[R.charCodeAt(Q + 2)] << 6) | r[R.charCodeAt(Q + 3)]),
						(D[L++] = (S >> 16) & 255),
						(D[L++] = (S >> 8) & 255),
						(D[L++] = S & 255)
				return (
			...
			function k(R) {
				...
				return (
					N === 1
						...
						: N === 2 && ((S = (R[M - 2] << 8) + R[M - 1]), U.push(t[S >> 10] + t[(S >> 4) & 63] + t[(S << 2) & 63] + '=')),
					U.join('')
				)
			}
		}),
		...
		function (e, t, r) {
			...
			return (
				Number.isInteger(r) && Math.abs(r) > 2 ** 32
					? (i = ci(String(r)))
					: typeof r == 'bigint' &&
						((i = String(r)), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = ci(i)), (i += 'n')),
...
var gn,
	...
	Ni = !0
typeof y < 'u' &&
	(({ FORCE_COLOR: gn, NODE_DISABLE_COLORS: Oi, NO_COLOR: Di, TERM: Mi } = y.env || {}), (Ni = y.stdout && y.stdout.isTTY))
...
A.toDecimalPlaces = A.toDP = function (e, t) {
	var r = this,
		n = r.constructor
	return (r = new n(r)), e === void 0 ? r : (ie(e, 0, Me), t === void 0 ? (t = n.rounding) : ie(t, 0, 8), I(r, e + r.e + 1, t))
}
A.toExponential = function (e, t) {
	...
	return (
		e === void 0
			? (r = he(n, !0))
			: (ie(e, 0, Me), t === void 0 ? (t = i.rounding) : ie(t, 0, 8), (n = I(new i(n), e + 1, t)), (r = he(n, !0, e + 1))),
...
A.toSignificantDigits = A.toSD = function (e, t) {
	var r = this,
		n = r.constructor
	return (
		e === void 0 ? ((e = n.precision), (t = n.rounding)) : (ie(e, 1, Me), t === void 0 ? (t = n.rounding) : ie(t, 0, 8)),
		I(new n(r), e, t)
	)
}
A.toString = function () {
	...
	return (
		...
		n == null
			...
			: t < 4
				...
				: (s =
						(((n || r < 4) && a + 1 == o) || (!n && r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 1e3) | 0) == H(10, t - 3) - 1),
		s
	)
}
function wr(e, t, r) {
	...
	return function (n, i, o, s, a, l) {
		...
		if (
			...
			if (((Q = (Q / k + 2) | 0), (h = 0), pe == 1)) {
				for (T = 0, j = j[0], Q++; (h < Pt || T) && Q--; h++) (en = T * l + (Z[h] || 0)), (U[h] = (en / j) | 0), (T = en % j | 0)
				R = T || h < Pt
			} else {
				for (
					T = (l / (j[0] + 1)) | 0,
...
function Er(e, t) {
	...
	if (((t = t.slice(n, i)), t)) {
		...
		for (; n--; ) t += '0'
		e.d.push(+t),
			_ && (e.e > e.constructor.maxE ? ((e.d = null), (e.e = NaN)) : e.e < e.constructor.minE && ((e.e = 0), (e.d = [0])))
	} else (e.e = 0), (e.d = [0])
	return e
}
function Ml(e, t) {
...
function Rn(e, t, r, n) {
	var i,
		...
		k = e.constructor,
		R = r !== void 0
	if ((R ? (ie(r, 1, Me), n === void 0 ? (n = k.rounding) : ie(n, 0, 8)) : ((r = k.precision), (n = k.rounding)), !e.isFinite()))
		g = vo(e)
	else {
		for (
			g = he(e),
				...
				s >= 0 && ((g = g.replace('.', '')), (T = new k(1)), (T.e = g.length - s), (T.d = wr(he(T), 10, i)), (T.e = T.d.length)),
				h = wr(g, 10, i),
				o = l = h.length;
			h[--l] == 0;
		...
		if (!h[0]) g = R ? '0p+0' : '0'
			...
			if (
				(s < 0 ? o-- : ((e = new k(e)), (e.d = h), (e.e = o), (e = V(e, T, r, n, 0, i)), (h = e.d), (o = e.e), (f = go)),
				(s = h[r]),
				(a = i / 2),
				(f = f || h[r + 1] !== void 0),
				(f =
...
function Qr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
	if (Array.isArray(t)) {
		for (let s = 0; s < t.length; s++) t[s] = Qr({ result: t[s], args: r, modelName: i, runtimeDataModel: n, visitor: e })
		return t
	}
	let o = e(t, i, r) ?? t
	return (
...
function Ls({ copyEngine: e = !0 }, t) {
	...
	e &&
		n &&
		yr('recommend--no-engine', 'In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)')

...
var _e = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
	...
	cn = (t, e, r, n) => {
		if ((e && typeof e == 'object') || typeof e == 'function')
			for (let i of zo(e)) !Xo.call(t, i) && i !== r && St(t, i, { get: () => e[i], enumerable: !(n = Ho(e, i)) || n.enumerable })
		return t
	}
var rt = (t, e, r) => (
		(r = t != null ? Ko(Yo(t)) : {}), cn(e || !t || !t.__esModule ? St(r, 'default', { value: t, enumerable: !0 }) : r, t)
	),
	...
	En = ue(() => {
		...
		R.toDecimalPlaces = R.todp = function (t, e) {
			var r = this,
				n = r.constructor
			return (
				(r = new n(r)), t === void 0 ? r : (me(t, 0, De), e === void 0 ? (e = n.rounding) : me(e, 0, 8), D(r, t + V(r) + 1, e))
			)
		}
		R.toExponential = function (t, e) {
			...
			return (
				t === void 0
					? (r = ke(n, !0))
					: (me(t, 0, De), e === void 0 ? (e = i.rounding) : me(e, 0, 8), (n = D(new i(n), t + 1, e)), (r = ke(n, !0, t + 1))),
				r
			)
		}
		...
		R.toSignificantDigits = R.tosd = function (t, e) {
			var r = this,
				n = r.constructor
			return (
				t === void 0 ? ((t = n.precision), (e = n.rounding)) : (me(t, 1, De), e === void 0 ? (e = n.rounding) : me(e, 0, 8)),
				D(new n(r), t, e)
			)
		}
		R.toString =
		...
		be = (function () {
			...
			return function (n, i, o, s) {
				...
				for (f = n.e - i.e, se = q.length, _ = le.length, A = new At(Wo), O = A.d = [], g = 0; q[g] == (le[g] || 0); ) ++g
				if ((q[g] > (le[g] || 0) && --f, o == null ? (K = o = At.precision) : s ? (K = o + (V(n) - V(i)) + 1) : (K = o), K < 0))
					return new At(0)
...
var kr,
	...
	An = !0
typeof h < 'u' &&
	(({ FORCE_COLOR: kr, NODE_DISABLE_COLORS: Tn, NO_COLOR: Cn, TERM: Rn } = h.env || {}), (An = h.stdout && h.stdout.isTTY))
...
var Xt = class {
		...
		getAllComputedFields(e) {
			return this.computedFieldsCache.getOrCreate(e, () => xi(this.previous?.getAllComputedFields(e), this.extension, e))
		}
...
function Oa(t, e, r) {
	let n = {}
	return t.modelOrType && !t.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), e && Ia(n, e, t), Ma(n, r, t), n
}
function Ia(t, e, r) {
...
function go({ copyEngine: t = !0 }, e) {
	...
	t &&
		n &&
		lt('recommend--no-engine', 'In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)')
...
Expected string or undefined.`)
		...
		log: t => {
			if (!t) return
			if (!Array.isArray(t)) throw new L(`Invalid value ${JSON.stringify(t)} for "log" provided to PrismaClient constructor.`)
			function e(r) {
		...
		__internal: t => {
			...
			if (typeof t != 'object') throw new L(`Invalid value ${JSON.stringify(t)} for "__internal" to PrismaClient constructor`)

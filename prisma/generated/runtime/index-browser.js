...
var Me = (e, n) => {
	...
	Ge = (e, n, i, t) => {
		if ((n && typeof n == 'object') || typeof n == 'function')
			for (let r of We(n)) !Je.call(e, r) && r !== i && he(e, r, { get: () => n[r], enumerable: !(t = je(n, r)) || t.enumerable })
		return e
	}
...
h.hyperbolicCosine = h.cosh = function () {
	...
	;(i = o.precision),
		...
		(o.rounding = 1),
		(r = s.d.length),
		r < 32 ? ((e = Math.ceil(r / 3)), (n = (1 / ce(4, e)).toString())) : ((e = 16), (n = '2.3283064365386962890625e-10')),
	...
	return (
		...
		t == null
			...
			: n < 4
				...
				: (o =
						(((t || i < 4) && u + 1 == s) || (!t && i > 3 && u + 1 == s / 2)) && ((e[r + 1] / s / 1e3) | 0) == C(10, n - 3) - 1),
		o
	)
}
function ie(e, n, i) {
...
function cn(e, n) {
	...
	;(t = n.d.length),
		t < 32 ? ((i = Math.ceil(t / 3)), (r = (1 / ce(4, i)).toString())) : ((i = 16), (r = '2.3283064365386962890625e-10')),
		(e.precision += i),
...
function Se(e, n, i, t) {
	var r,
		...
		g = e.constructor,
		v = i !== void 0
	if ((v ? (A(i, 1, V), t === void 0 ? (t = g.rounding) : A(t, 0, 8)) : ((i = g.precision), (t = g.rounding)), !e.isFinite()))
		l = Be(e)
	else {
		for (
			l = L(e),
				...
				o >= 0 && ((l = l.replace('.', '')), (d = new g(1)), (d.e = l.length - o), (d.d = ie(L(d), 10, r)), (d.e = d.d.length)),
				a = ie(l, 10, r),
				s = c = a.length;
			a[--c] == 0;
...
function Cn(e) {
	...
	var n,
		...
		t,
		r = e.defaults === !0,
		s = ['precision', 1, V, 'rounding', 0, 8, 'toExpNeg', -H, 0, 'toExpPos', 0, H, 'maxE', 0, H, 'minE', -H, 0, 'modulo', 0, 9]

...
var he = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
	...
	ri = (e, t, r, n) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let i of ba(t)) !xa.call(e, i) && i !== r && er(e, i, { get: () => t[i], enumerable: !(n = wa(t, i)) || n.enumerable })
		return e
	}
var Re = (e, t, r) => (
		(r = e != null ? ya(Ea(e)) : {}), ri(t || !e || !e.__esModule ? er(r, 'default', { value: e, enumerable: !0 }) : r, e)
	),
...
var xi = he(et => {
	...
	var ai = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
		va = ai(e => {
			...
			function g(C) {
				...
				for (U = 0; U < $; U += 4)
					(A =
						(r[C.charCodeAt(U)] << 18) | (r[C.charCodeAt(U + 1)] << 12) | (r[C.charCodeAt(U + 2)] << 6) | r[C.charCodeAt(U + 3)]),
						(I[D++] = (A >> 16) & 255),
						(I[D++] = (A >> 8) & 255),
						(I[D++] = A & 255)
				return (
			...
			function R(C) {
				...
				return (
					_ === 1
						...
						: _ === 2 && ((A = (C[O - 2] << 8) + C[O - 1]), L.push(t[A >> 10] + t[(A >> 4) & 63] + t[(A << 2) & 63] + '=')),
					L.join('')
				)
			}
		}),
		...
		Yr = va(),
		Ze = Ta(),
		ni = typeof Symbol == 'function' && typeof Symbol.for == 'function' ? Symbol.for('nodejs.util.inspect.custom') : null
	et.Buffer = T
	et.SlowBuffer = Oa
	...
	function tn(e) {
		if (e >= tr) throw new RangeError('Attempt to allocate Buffer larger than maximum size: 0x' + tr.toString(16) + ' bytes')
		return e | 0
	}
	function Oa(e) {
		...
		function (e, t, r) {
			...
			return (
				Number.isInteger(r) && Math.abs(r) > 2 ** 32
					? (i = si(String(r)))
					: typeof r == 'bigint' &&
						((i = String(r)), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = si(i)), (i += 'n')),
...
var cn,
	...
	Ri = !0
typeof y < 'u' &&
	(({ FORCE_COLOR: cn, NODE_DISABLE_COLORS: Ci, NO_COLOR: Ai, TERM: Si } = y.env || {}), (Ri = y.stdout && y.stdout.isTTY))
...
S.hyperbolicCosine = S.cosh = function () {
	...
	;(r = s.precision),
		...
		(s.rounding = 1),
		(i = o.d.length),
		i < 32 ? ((e = Math.ceil(i / 3)), (t = (1 / hr(4, e)).toString())) : ((e = 16), (t = '2.3283064365386962890625e-10')),
...
S.toDecimalPlaces = S.toDP = function (e, t) {
	var r = this,
		n = r.constructor
	return (r = new n(r)), e === void 0 ? r : (oe(e, 0, Be), t === void 0 ? (t = n.rounding) : oe(t, 0, 8), k(r, e + r.e + 1, t))
}
S.toExponential = function (e, t) {
	...
	return (
		e === void 0
			? (r = Ee(n, !0))
			: (oe(e, 0, Be), t === void 0 ? (t = i.rounding) : oe(t, 0, 8), (n = k(new i(n), e + 1, t)), (r = Ee(n, !0, e + 1))),
...
S.toSignificantDigits = S.toSD = function (e, t) {
	var r = this,
		n = r.constructor
	return (
		e === void 0 ? ((e = n.precision), (t = n.rounding)) : (oe(e, 1, Be), t === void 0 ? (t = n.rounding) : oe(t, 0, 8)),
		k(new n(r), e, t)
	)
}
S.toString = function () {
	...
	return (
		...
		n == null
			...
			: t < 4
				...
				: (s =
						(((n || r < 4) && a + 1 == o) || (!n && r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 1e3) | 0) == W(10, t - 3) - 1),
		s
	)
}
function ur(e, t, r) {
...
function Xl(e, t) {
	...
	;(n = t.d.length),
		n < 32 ? ((r = Math.ceil(n / 3)), (i = (1 / hr(4, r)).toString())) : ((r = 16), (i = '2.3283064365386962890625e-10')),
		(e.precision += r),
	...
	return function (n, i, o, s, a, l) {
		...
		if (
			...
			if (((U = (U / R + 2) | 0), (h = 0), Y == 1)) {
				for (v = 0, j = j[0], U++; (h < re || v) && U--; h++) (xt = v * l + (Z[h] || 0)), (L[h] = (xt / j) | 0), (v = xt % j | 0)
				C = v || h < re
			} else {
				for (
					v = (l / (j[0] + 1)) | 0,
...
function cr(e, t) {
	...
	if (((t = t.slice(n, i)), t)) {
		...
		for (; n--; ) t += '0'
		e.d.push(+t),
			F && (e.e > e.constructor.maxE ? ((e.d = null), (e.e = NaN)) : e.e < e.constructor.minE && ((e.e = 0), (e.d = [0])))
	} else (e.e = 0), (e.d = [0])
	return e
}
function eu(e, t) {
...
function Rn(e, t, r, n) {
	var i,
		...
		R = e.constructor,
		C = r !== void 0
	if ((C ? (oe(r, 1, Be), n === void 0 ? (n = R.rounding) : oe(n, 0, 8)) : ((r = R.precision), (n = R.rounding)), !e.isFinite()))
		g = mo(e)
	else {
		for (
			g = Ee(e),
				...
				s >= 0 && ((g = g.replace('.', '')), (v = new R(1)), (v.e = g.length - s), (v.d = ur(Ee(v), 10, i)), (v.e = v.d.length)),
				h = ur(g, 10, i),
				o = l = h.length;
			h[--l] == 0;
		...
		if (!h[0]) g = C ? '0p+0' : '0'
			...
			if (
				(s < 0 ? o-- : ((e = new R(e)), (e.d = h), (e.e = o), (e = q(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (u = oo)),
				(s = h[r]),
				(a = i / 2),
				(u = u || h[r + 1] !== void 0),
				(u =
			...
			for (let A in r) {
				...
				for (let _ = 0; _ < O.length; ++_) {
					...
					for (let J = n, re = i; J < t.length; re += t[J].length, ++J) {
						...
						if (
							(Y.push(ze), C && Y.push(C), Array.prototype.splice.apply(t, Y), u != 1 && N.matchGrammar(e, t, r, J, re, !0, A), o)
						)
							break
					}
				}
...
function Ic(e, t, r) {
	let n = {}
	return e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Mc(n, t, e), _c(n, r, e), n
}
function Mc(e, t, r) {
...
function Wc(e) {
	var t = Gc.exec(e)
	return t ? { file: t[2], methodName: t[1] || Ht, arguments: [], lineNumber: +t[3], column: t[4] ? +t[4] : null } : null
}
var Kc =
...
function Zc(e) {
	var t = Yc.exec(e)
	return t ? { file: t[3], methodName: t[1] || Ht, arguments: [], lineNumber: +t[4], column: t[5] ? +t[5] : null } : null
}
...
`
		...
		.map(t =>
			t.replace(/^\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)\s*/, '').replace(/\+\d+\s*ms$/, '')
		).join(`
`)
}
m()
...
function Bs({ copyEngine: e = !0 }, t) {
	...
	e &&
		n &&
		Ft('recommend--no-engine', 'In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)')

...
var Le = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
	...
	mi = (e, t, r, n) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let i of Ta(t)) !Aa.call(e, i) && i !== r && Ct(e, i, { get: () => t[i], enumerable: !(n = va(t, i)) || n.enumerable })
		return e
	}
var We = (e, t, r) => (
		(r = e != null ? Pa(Ca(e)) : {}), mi(t || !e || !e.__esModule ? Ct(r, 'default', { value: e, enumerable: !0 }) : r, e)
	),
...
var Oi = Le(Ye => {
	...
	var yi = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
		...
		cn = ka(),
		Ke = Ia(),
		di = typeof Symbol == 'function' && typeof Symbol.for == 'function' ? Symbol.for('nodejs.util.inspect.custom') : null
	Ye.Buffer = C
	Ye.SlowBuffer = Fa
		...
		function (e, t, r) {
			...
			return (
				Number.isInteger(r) && Math.abs(r) > 2 ** 32
					? (i = hi(String(r)))
					: typeof r == 'bigint' &&
						((i = String(r)), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = hi(i)), (i += 'n')),
...
var Pn,
	...
	Bi = !0
typeof y < 'u' &&
	(({ FORCE_COLOR: Pn, NODE_DISABLE_COLORS: _i, NO_COLOR: Fi, TERM: Li } = y.env || {}), (Bi = y.stdout && y.stdout.isTTY))
...
A.toExponential = function (e, t) {
	...
	return (
		e === void 0
			? (r = he(n, !0))
			: (se(e, 0, Me), t === void 0 ? (t = i.rounding) : se(t, 0, 8), (n = I(new i(n), e + 1, t)), (r = he(n, !0, e + 1))),
...
A.toSignificantDigits = A.toSD = function (e, t) {
	var r = this,
		n = r.constructor
	return (
		e === void 0 ? ((e = n.precision), (t = n.rounding)) : (se(e, 1, Me), t === void 0 ? (t = n.rounding) : se(t, 0, 8)),
		I(new n(r), e, t)
	)
}
A.toString = function () {
...
function Vl(e, t) {
	...
	;(n = t.d.length),
		n < 32 ? ((r = Math.ceil(n / 3)), (i = (1 / Ar(4, r)).toString())) : ((r = 16), (i = '2.3283064365386962890625e-10')),
		(e.precision += r),
...
function _n(e, t, r, n) {
	var i,
		...
		k = e.constructor,
		R = r !== void 0
	if ((R ? (se(r, 1, Me), n === void 0 ? (n = k.rounding) : se(n, 0, 8)) : ((r = k.precision), (n = k.rounding)), !e.isFinite()))
		g = Ao(e)
	else {
		for (
			g = he(e),
		...
		if (!h[0]) g = R ? '0p+0' : '0'
			...
			if (
				(s < 0 ? o-- : ((e = new k(e)), (e.d = h), (e.e = o), (e = V(e, T, r, n, 0, i)), (h = e.d), (o = e.e), (f = wo)),
				(s = h[r]),
				(a = i / 2),
				(f = f || h[r + 1] !== void 0),
				(f =
...
function Gs({ copyEngine: e = !0 }, t) {
	...
	e &&
		n &&
		Ot('recommend--no-engine', 'In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)')
